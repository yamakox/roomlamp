...
It is in early development. The current build is a launch skeleton: it loads your kubeconfig and shows the current context. It does not list workloads or change cluster objects yet.
