...
It is in early development. The current build lists Pods in the current namespace (Watch-backed), opens a read-only detail view, and lets you switch namespaces. It does not edit cluster objects yet.
